                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input name="occupation" type="text" class="form-control { $errors->has('email') ? 'is-invalid' : '' }} " value="{{old('occuptaion') ? : Auth::user()->occupation }}" required />
                            ...
                            <div class="mb-4">
                                ...
                                <input name="card_number" type="number" class="form-control { $errors->has('name') ? 'is-invalid' : '' }} " value="{{ old('card_number') ? : '' }}" required />
